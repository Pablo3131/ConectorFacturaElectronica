 ...
 * @author Usuario
 */
public class EnviarFacturaHandler implements SOAPHandler<SOAPMessageContext>{
    @Override
        ...
        try {
            ...
            if (bolMsgSalida) {
                try {
                    ...
                    SOAPElement soapElementoCabecera1 = soapFactory.createElement("EnviarFactura").addAttribute(new QName("xmlns:i"), "http://www.w3.org/2001/XMLSchema-instance");
                ...
                SOAPElement elementoSoap2 = soapFactory.createElement("EnviarFacturaResponse", "", "http://WSFacturaElectronica/");
